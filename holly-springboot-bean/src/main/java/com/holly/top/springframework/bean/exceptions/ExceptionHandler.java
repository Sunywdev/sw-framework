package com.holly.top.springframework.bean.exceptions;
...
public class ExceptionHandler {
     ...
     */
    @ResponseBody
    @org.springframework.web.bind.annotation.ExceptionHandler({BindException.class,MethodArgumentNotValidException.class,ConstraintViolationException.class})
    @ResponseStatus(HttpStatus.OK)
